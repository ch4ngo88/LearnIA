...
<body>
  <div class="cardStyle">
    <form action="../../../backend/controllers/changepw.php" method="post" name="signupForm" id="signupForm">
      <img src="../../assets/images/logo.png" id="loginLogo" class="logoImage" alt="LearnIA Logo" />
      <h2 class="formTitle">Passwort ändern</h2>
      <div class="inputDiv">
        <label class="inputLabel" for="oldPassword">Altes Passwort</label>
        <input type="password" id="oldPassword" name="oldpw" required>
      </div>
      <div class="inputDiv">
        <label class="inputLabel" for="newPassword">Neues Passwort</label>
        <input type="password" id="newPassword" name="newpw" required>
      </div>
      <div class="inputDiv">
        <label class="inputLabel" for="confirmPassword">Passwort bestätigen</label>
        <input type="password" id="confirmPassword" name="newpwc" required>
      </div>
